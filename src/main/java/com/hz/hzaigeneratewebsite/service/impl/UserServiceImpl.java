...
import com.hz.hzaigeneratewebsite.mapper.UserMapper;
import com.hz.hzaigeneratewebsite.model.dto.user.UserQueryRequest;
import com.hz.hzaigeneratewebsite.model.entity.User;
import com.hz.hzaigeneratewebsite.model.enums.UserRoleEnum;
...
import static com.hz.hzaigeneratewebsite.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    public User getLoginUser(HttpServletRequest request) {
        ...
        // 从数据库查询当前用户信息。拿到对象的id 对象的id是不变的，拿到id再去查数据库最新的数据
